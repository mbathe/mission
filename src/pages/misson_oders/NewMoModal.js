...
export default function MissionOder(props) {
        ...
        onSubmit: async () => {
           ...
           // handleClick()
            ...
            const newMissionOrder = {
                    ...
                    corresp_sag_id: correspondantSagSelect.map(r => r.USER_ID).join(';'),
           ...
           setLoading(true);
            ...
            axios.post(`${process.env.REACT_APP_BACKEND_URL}/mission_order/`, newMissionOrder)
                .then((res) => { 
                    handleOk();
                    setLoading(false);
                    console.log(res); 
